...
entityName Varchar(50) NOT NULL DEFAULT 'subjectproblem',
   ...
   lastaccess DATETIME,
    ...
    REFERENCES Problem(problemId) ON DELETE CASCADE ON UPDATE CASCADE,
...
entityName Varchar(50) NOT NULL DEFAULT 'Observerproblem',
   ...
   lastaccess DATETIME,
    ...
    REFERENCES Observer(ObserverId) ON DELETE CASCADE ON UPDATE CASCADE
...
entityName Varchar(50) NOT NULL DEFAULT 'Commandproblem',
   ...
   lastaccess DATETIME,
    ...
    REFERENCES Command(CommandId) ON DELETE CASCADE ON UPDATE CASCADE
...
entityName Varchar(50) NOT NULL DEFAULT 'SubjectProblem2SubjectProblem',
   ...
   lastaccess DATETIME,
    ...
    REFERENCES SubjectProblem(subjectproblemId) ON DELETE CASCADE ON UPDATE CASCADE,
...
entityName Varchar(50) NOT NULL DEFAULT 'ObserverProblem2ObserverProblem',
   ...
   lastaccess DATETIME,
    ...
    REFERENCES ObserverProblem(observerproblemId) ON DELETE CASCADE ON UPDATE CASCADE,
...
entityName Varchar(50) NOT NULL DEFAULT 'CommandProblem2CommandProblem',
   ...
   lastaccess DATETIME,
    ...
    REFERENCES CommandProblem(commandproblemId) ON DELETE CASCADE ON UPDATE CASCADE,
...
entityName Varchar(50) NOT NULL DEFAULT 'ActionProblem2ActionProblem',
   ...
   lastaccess DATETIME,
    ...
    REFERENCES ActionProblem(actionproblemId) ON DELETE CASCADE ON UPDATE CASCADE,
